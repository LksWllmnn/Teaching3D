...
class MultiWinApp:
    ...
    def run(self):
        ...
        #                         self.on_snapshot)
        self.main_vis.add_action("Say Hello", self.on_Hello)
        self.main_vis.add_action("Add Cube", self.create_rotating_cube)
    ...
    def on_Hello(self, vis):
        print("Hello World")
    
    def create_rotating_cube(self):
        ...
        o3d.visualization.gui.Application.instance.post_to_main_thread(self.main_vis, createLines)
